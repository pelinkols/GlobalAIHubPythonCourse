...
I created a new list called squares to be able to multiply all values in newlist by 2. I used the "square.sort" due to sorting the values in increasing order.
